        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8 mx-auto">
                    ...
                    <h1 style="color:black;"><b>{{ $category->name }}</b></h1>
                    <p class="lead-2 opacity-80 mt-2" style="color:black;"><i>"Artikel berdasarkan kategori di atas."</i></p>
